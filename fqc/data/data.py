...
- All slices are assumed to be those such that slice_granularity = 2,
...
# Hyperparemeters for Grape on ADAM indexed by slice.
# Determined by /project/ftchong/qoc/thomas/hpo/uccsd_lih_slice_hpo.
UCCSD_LIH_SLICE_HYPERPARAMETERS = [
    {'lr': 2e-2, 'decay': 1e3}, #s0
    {'lr': 2e-2, 'decay': 1e3}, #s1
    {'lr': 2e-2, 'decay': 1e3}, #s2
    {'lr': 2e-2, 'decay': 1e3}, #s3
    {'lr': 3.2e-3, 'decay': 2e4}, #s4
    {'lr': 6.2e-3, 'decay': 5e3}, #s5
    {'lr': 1.2e-2, 'decay': 3e3}, #s6
    {'lr': 1.1e-3, 'decay': 3e3}, #s7
]
...
# The pulse time for the full uccsd lih circuit. This time corresponds
# to that found by binary search at
# /project/ftchong/qoc/thomas/uccsd_full_time/lih/
# plus the maximum pulse time for an RZ gate times the number of RZ gates
# in the circuit.
UCCSD_LIH_FULL_TIME = 0 + _rz * 40
