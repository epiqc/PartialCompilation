...
def Grape(H0, Hops, Hnames, U, total_time, steps, states_concerned_list, convergence=None, U0=None, reg_coeffs=None, dressed_info=None, maxA=None, use_gpu=True, sparse_H=True, sparse_U=False, sparse_K=False, draw=None, initial_guess=None, save_plots=False, unitary_error=1e-4, method='Adam', state_transfer=False, no_scaling=False, freq_unit='GHz', file_name=None, save=True, data_path=None, Taylor_terms=None, use_inter_vecs=True):
    ...
    if convergence is None:
        convergence = {'rate': 0.01, 'update_step': 50, 'max_iterations': 5000,
    ...
    sys_para = SystemParameters(H0, Hops, Hnames, U, U0, total_time, steps, 
        ...
        save_plots, unitary_error, state_transfer, no_scaling, reg_coeffs, 
        save, file_path, Taylor_terms, use_gpu, use_inter_vecs, sparse_H, 
        sparse_U, sparse_K)
    ...
    try:
        SS = run_session(tfs, graph, conv, sys_para, method, use_gpu=use_gpu)
