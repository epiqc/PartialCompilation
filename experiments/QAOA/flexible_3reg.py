...
print("Experiment Flexible 3Reg N=%d p=%d slice=%d" % (graph_N, graph_p, slice_id))
data_path = config.DATA_PATH
file_name = datetime.today().strftime('%h%d_flex3regN%dp%d_slice_%s' % (graph_N, graph_p, slice_id))
